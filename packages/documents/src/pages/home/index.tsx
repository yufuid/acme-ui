      ...
      <div className={HomeLess.headerWrapper}>
        ...
        <div className={HomeLess.headerInner}>
          ...
          <div className={HomeLess.headerContent}>
            ...
            <p>我们将这些思考和沉淀，抽象形成了一些稳定且高复用性的内容，逐渐打磨出一套服务于产品设计的设计模式和实践方法。</p>
            <div className={HomeLess.controls}>
              <Link className={HomeLess.control} to="/components">组件</Link>
              <Link className={HomeLess.control} to="/develop">开始使用</Link>
            </div>
          </div>
        </div>
      </div>
